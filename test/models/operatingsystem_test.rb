...
class OperatingsystemTest < ActiveSupport::TestCase
  ...
  describe "families" do
    ...
    test "families_as_collection contains correct names and values" do
      ...
      assert_equal ["AIX", "Altlinux", "Arch Linux", "CoreOS", "Darwin", "Debian", "FreeBSD", "Gentoo", "Junos", "NX-OS", "Red Hat", "SUSE", "Solaris", "Windows", "XenServer"], families.map(&:name).sort
      assert_equal ["AIX", "Altlinux", "Archlinux", "Coreos", "Darwin", "Debian", "Freebsd", "Gentoo", "Junos", "NXOS", "Redhat", "Solaris", "Suse", "Windows", "Xenserver"], families.map(&:value).sort
    end
  end
